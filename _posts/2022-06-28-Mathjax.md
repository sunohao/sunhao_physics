---
layout: post
title: "Introduction of Jekyll and Mathjax"
date: 2022-07-09
categories: opinion
...
In this chapter, I will intruduce the [density matrix renormalization group approach](https://tensornetwork.org/mps/algorithms/dmrg/) in strongly-correlated quantum magnetic system, using **XXX-Heisenberg** model as an explicit example.
...
The very good instructions described by Dason Kurkiewicz for
